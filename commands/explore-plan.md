...
Please read the full context from .claude/sessions/context_session_{feature_name}.md and create your detailed implementation plan following your standard process. Save it to docs/features/{feature_name}/backend.md (or fastapi.md/drf.md as appropriate).
```

If there are things you are not sure about, use parallel subagents to do some web research. They should only return useful information, no noise.

# Update
Update the context_session file with:
